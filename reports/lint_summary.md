...
| ERROR | POS tokens must map to existing DULAT tokens in column 4 | 14 |
...
| ERROR | No DULAT entry found for lexeme/surface | 10 |
...
| ERROR | trḫ Verb stem marker(s) required by POS but missing in analysis: :d | 5 |
...
| ERROR | hbṭ Verb stem marker(s) required by POS but missing in analysis: :d | 3 |
| ERROR | prˤ Verb stem marker(s) required by POS but missing in analysis: :d | 3 |
...
| ERROR | Multiple DULAT candidates for lexeme | 1 |
| ERROR | brkn Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
| ERROR | klyn Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
| ERROR | klyy Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
| ERROR | l Formula tbˤ w l yṯb ilm expects l(II) ('not') | 1 |
| ERROR | mˤqbk Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
| ERROR | uḫryt Adjective POS gender mismatch for ủḫry: expected adj. m., got adj. f. | 1 |
| ERROR | wpṯm Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
| ERROR | ḫtny Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
| ERROR | ṣmt Verb stem marker(s) required by POS but missing in analysis: :d | 1 |
...
| WARNING | gdlt Lexeme parse did not match DULAT; matched by surface form | 1 |
| WARNING | ilšnn Lexeme-final n/y should stay in stem; avoid '/+n' or '/+y' split without explicit DULAT suffix token | 1 |
| WARNING | klt Lexeme parse did not match DULAT; matched by surface form | 1 |
