...
|---|---|---:|
| ERROR | Analysis does not reconstruct to surface | 4027 |
| INFO | Surface not found in UDB concordance | 1619 |
| ERROR | POS token not allowed for declared DULAT entry | 481 |
...
| WARNING | Suffix form without '+' | 105 |
...
| ERROR | bˤl For /b-ʕ-l/ verbal readings, use canonical analysis with `[/` (e.g., bˤl[/) | 10 |
| ERROR | bˤl In KTU 1.*, remove bʕl(I) 'labourer' and keep bʕl (II) /b-ʕ-l/ readings | 10 |
